...
public class create extends Acontrol {
    ...
    public void Insert() throws InterruptedException {
        if(phone.getText().equals("")||u_name.getText().equals("") || f_name.getText().equals("") || l_name.getText().equals("") || password.getText().equals("") ||city.getText().equals("") || BDay.toString().equals("") )
            ...
            conection_layer.Insert(phone.getText(),u_name.getText(), password.getText(), BDay.toString(), f_name.getText(), l_name.getText(), city.getText());
